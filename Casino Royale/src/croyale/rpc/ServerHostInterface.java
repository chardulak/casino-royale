...
public interface ServerHostInterface extends Remote
{
	...
	public SealedObject checkPlayer(SealedObject sealed_user_id, SealedObject sealed_password) throws RemoteException; // returns -2 if user already logged in, -1 if user does not exist
